...
For \texttt{wl-20}, Figure \ref{figure_jobwaittime} shows that \SEzero{} has
...
The total makespans of each workload, which is depicted in Figure
...
The results are illustrated in Figure \ref{figure_vm_util}. Although in
